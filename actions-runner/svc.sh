...
SVC_NAME="actions.runner.jigarlpatel-Linux-Assignment1.jigarLinux.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (jigarlpatel-Linux-Assignment1.jigarLinux)"
